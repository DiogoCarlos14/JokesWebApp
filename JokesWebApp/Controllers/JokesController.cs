...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Create([Bind("Id,JokePergunta,JokesRespostas,Autor")] Jokes jokes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokePergunta,JokesRespostas")] Jokes jokes)
        {
            if (id != jokes.Id)
            {
                return NotFound();
